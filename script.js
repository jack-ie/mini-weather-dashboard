...
function currentWeather(city) {
  var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=imperial&APPID=68056ac49e78d598d69105c5cc119b53";
  ...
  $.ajax({
    ...
    function uvIndex() {
      var queryURL = "https://api.openweathermap.org/data/2.5/uvi?lat=" + lat + "&lon=" + lon + "&appid=68056ac49e78d598d69105c5cc119b53";
...
function fiveDayForecast(city) {
  var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q=" + city + ",us&units=imperial&APPID=68056ac49e78d598d69105c5cc119b53";
